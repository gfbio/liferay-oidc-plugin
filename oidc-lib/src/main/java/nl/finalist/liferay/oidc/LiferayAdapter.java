...
public interface LiferayAdapter {
	...
	/**
	 * Create user or update if already existing. Keys to base existance on are:
	 * companyId, emailAddress. GivenName and familyName are used for setting
	 * the according fields.
	 *
	 * @param companyId
	 *            the virtual instance id
	 * @param emailAddress
	 *            the email address of the Liferay user
	 * @param firstName
	 *            the first name of the Liferay user
	 * @param lastName
	 *            last name of the Liferay user
	 * @param goesternID
